...
terrain1 = imread('data/n58_e006_1arc_v3.tif')
...
patch = terrain1[0:patch_size_row,0:patch_size_col]
z = np.array(patch.reshape(-1,1))

patchtest = terrain1[patch_size_row:2*patch_size_row,patch_size_col:2*patch_size_col]
